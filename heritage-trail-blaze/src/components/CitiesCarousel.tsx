...
const cities = [
  ...
  },
  {
    id: 'pune',
    name: 'Pune',
    image: 'https://images.unsplash.com/photo-1558383817-8ebcfb56f8c8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80',
    description: 'Discover the cultural capital of Maharashtra with its rich Maratha history'
  },
  {
    id: 'nagpur',
    name: 'Nagpur',
    image: 'https://images.unsplash.com/photo-1626331640794-57aa1bc30891?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80',
